...
<body>
    ...
    ?>
                ...
                <div class="panel-body">
                    <form action="" method="POST" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo $row['plan_from_date']; ?></span>
                        </div>
                    </form>
                </div>              
            </div>
        ...
        <div class="col-md-5" style="margin-top: 5rem; margin-left: 18rem;">
           <a href="expensedistribution.php"> <button name="login" class="btn" style="background: RGB(1,136,122); color:#fff;">Expense Distribution</button></a>
        </div>

    </div>

    <div class="col-md-5" style="float:right; margin:8rem;">
            <div class="panel panel-default" style="margin-top:10px;">
            <div class="panel-heading text-center" style="background:RGB(1,136,122); color:#fff;">
                ...
                <form action="" method="POST" autocomplete="off">
                        ...
                        <a href="addnewexpense.php"><button name="sign_up" class="btn btn-sm btn-block" style="background: RGB(1,136,122); color: #fff;">Add</button></a>
                    </form>
                </div>              
            </div>
        </div>
